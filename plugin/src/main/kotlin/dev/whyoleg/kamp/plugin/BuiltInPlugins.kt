...
open class BuiltInPlugins {
    ...
    val application = Plugin("org.gradle.application")
    val mavenPublish = Plugin("org.gradle.maven-publish")
    val javaPlugin = Plugin("org.gradle.java-gradle-plugin")
    val jib = Plugin("com.google.cloud.tools.jib", BuiltInDependencies.docker)
